...
(function () {
  ...
  class AssessmentHelper {
    constructor() {
      ...
      this.settingsKeys = {
        ...
        w_mood: "ah_w_mood",
        ai_openrouter_url: "ah_ai_openrouter_url",
        ai_openrouter_key: "ah_ai_openrouter_key",
        ai_openrouter_model: "ah_ai_openrouter_model",
        ai_key_visible: "ah_ai_openrouter_key_visible",
      };
      this.defaults = {
        mc_wait: 300,
        mc_random_pct: 0,
    ...
    async fetchArticleContent() {
      try {
        ...
        const questionContainer =
          document.querySelector("h3.student-quiz-page__question");
    ...
    async fetchAnswer(queryContent, retryCount = 0) {
      ...
      try {
        ...
        const openrouterUrl = this.loadSetting(
          this.settingsKeys.ai_openrouter_url,
          "https://openrouter.ai/api/v1/chat/completions"
        );
        const openrouterModel = this.loadSetting(
          this.settingsKeys.ai_openrouter_model,
          "openrouter/elephant-alpha"
        );
        const openrouterKey = this.loadSetting(this.settingsKeys.ai_openrouter_key, "");
    ...
    openAISettings() {
      ...
      const DEFAULT_URL = "https://api.openrouter.com/openai/v1/chat/completions";
      ...
      const urlInput = this.createEl("input", {
        type: "text",
        id: "aiopenrouterUrlInput",
        value: this.loadSetting(this.settingsKeys.ai_openrouter_url, DEFAULT_URL),
        style: "flex:1;",
      });
      ...
      urlReset.addEventListener("click", () => {
        ...
        this.saveSetting(this.settingsKeys.ai_openrouter_url, DEFAULT_URL);
      });
      ...
      const modelInput = this.createEl("input", {
        type: "text",
        id: "aiopenrouterModelInput",
        value: this.loadSetting(this.settingsKeys.ai_openrouter_model, DEFAULT_MODEL),
        style: "flex:1;",
      });
      ...
      modelReset.addEventListener("click", () => {
        ...
        this.saveSetting(this.settingsKeys.ai_openrouter_model, DEFAULT_MODEL);
      });
      ...
      const KEY_VIS_KEY =
        this.settingsKeys.ai_key_visible || "ah_ai_openrouter_key_visible";
  ...
  `;
      ...
      const keyInput = this.createEl("input", {
        ...
        id: "aiopenrouterKeyInput",
        value: this.loadSetting(this.settingsKeys.ai_openrouter_key, ""),
      ...
      keyInput.addEventListener("change", () =>
        this.saveSetting(this.settingsKeys.ai_openrouter_key, keyInput.value || "")
      );
    ...
    async runSolverLoop() {
      const attemptOnce = async (excludedAnswers = []) => {
        ...
        try {
          ...
          if (1 == 2) {
            console.log("um ur not supposed to see this lol")
          } else {
